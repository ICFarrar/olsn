...
import pandas as pd
import sys
sys.path.insert(0, '/Users/icfar/Documents/GitHub/olsn/MyoInterface/build/lib/MyoInterface') #change address as appropriate
...
df = pd.DataFrame(columns = ['channel 1','channel 2','channel 3','channel 4','channel 5','channel 6','channel 7','channel 8',]) #start of creating dataframe to record data; WIP
data_count = 1
